...
{
    public class MeetingReportMultipartFormDataStreamProvider : MultipartFormDataStreamProvider
    {

        public MeetingReportMultipartFormDataStreamProvider(string path)
            : base(path)    
        {
        }
